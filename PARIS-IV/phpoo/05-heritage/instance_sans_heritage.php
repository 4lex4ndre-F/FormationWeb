...
Commentaires:
    ...
    L'interêt d'avoir une instance sans héritage (récupérer un objet dans la propriété d'une classe) est de pouvoir hériter d'une classe mère d'un côté tout en ayant la possibilité de récupérer les élements d'une autre classe en même temps.
*/