...
class B extends A
{
    public function calcul(){
        ...
        //return self::calcul() + 5; //Ne veut rien dire

        return parent::calcul() + 5;
        //return A::calcul() + 5;
        // Avec les deux proposition ci-dessus, on fait réellement appel à la méthode de NOTRE PARENT (class A)
    }
}
...
Commmentaires:
    ...
    par exemple, lorsque l'on travaille sur un CMS ou un FRAMEWORK, on n'a pas le droit de toucher aux fichiers du coeur de l'application, mais on peut hériter de certaines classes, et potentiellement modifier les traitements de certaines méthodes.
*/